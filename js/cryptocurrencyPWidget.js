...
if(document.querySelector('#coin-is-here')){
    ...
    listCryptocurrency = document.querySelector('#cryptocurrencyPrices').innerHTML += '<style>.drK .nomics-ticker-widget-bg-light{background-color: #4d4e51} .nomics-ticker-widget-embedded:not(:last-child) {margin-bottom: 20px;} .nomics-ticker-widget-embedded.nomics-ticker-widget-size-responsive{max-width: 100%;}</style>';
